...
export default function Home() {
  return (
    <div className="w-full relative px-6 lg:px-12 py-8 space-y-12">
      ...
      <div className="flex flex-col lg:flex-row relative gap-8 min-h-[75vh] items-stretch animate-bloom">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-between p-8 lg:p-16 bg-[#F5F1E6]/50 backdrop-blur-[2px] rounded-[2.5rem] border border-[#8F9C86]/15 relative z-10 shadow-sm">
          ...
          <div className="mt-16 lg:mt-0 reveal-text reveal-delay-2">
            <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#1F2B1A]/80 max-w-sm mb-10 leading-[2.2]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/catalog" className="inline-flex justify-center items-center px-10 py-4.5 bg-[#D27D5B] text-[#FAF6EE] text-[9px] tracking-[0.25em] uppercase font-bold rounded-full hover:bg-[#1F2B1A] transition-colors duration-500 shadow-md hover:shadow-lg">
                Explore Index
              </Link>
              <Link href="/dashboard" className="inline-flex justify-center items-center px-10 py-4.5 bg-transparent border border-[#1F2B1A]/20 text-[#1F2B1A] text-[9px] tracking-[0.25em] uppercase font-bold rounded-full hover:bg-[#1F2B1A]/5 transition-all duration-500">
                Workspace Portal
              </Link>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 h-[50vh] lg:h-auto relative overflow-hidden rounded-[2.5rem] group border border-[#8F9C86]/15 shadow-md">
           ...
           {/* Floating Badge */}
           <div className="absolute bottom-6 right-6 lg:bottom-10 lg:right-10 bg-[#FAF6EE] px-5 py-3 rounded-full border border-[#8F9C86]/20 shadow-lg reveal-text reveal-delay-3 flex items-center gap-2.5">
             <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#1F2B1A] flex items-center gap-2">
                <span className="w-2 h-2 bg-[#8F9C86] rounded-full animate-pulse"></span>
      ...
      <div className="bg-[#D27D5B] text-[#FAF6EE] py-4 overflow-hidden rounded-[1.5rem] shadow-sm">
        <div className="flex whitespace-nowrap animate-[marquee_25s_linear_infinite]">
          {Array(4).fill(0).map((_, i) => (
            <span key={i} className="text-[10px] uppercase tracking-[0.4em] font-bold mx-8 flex items-center gap-4">
      ...
      <div className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-10 lg:p-14 bg-[#F5F1E6]/40 backdrop-blur-[1px] border border-[#8F9C86]/15 rounded-[2rem] group hover:bg-[#1F2B1A] hover:text-[#FAF6EE] hover:-translate-y-1 transition-all duration-[0.8s] ease-out shadow-sm hover:shadow-xl">
            <span className="text-[10px] font-sans font-bold tracking-[0.25em] mb-10 block text-[#D27D5B] group-hover:text-[#FAF6EE]/80">🍃 SYS.01</span>
            ...
            <p className="text-[11px] font-sans uppercase tracking-[0.12em] leading-[2.2] opacity-75 group-hover:opacity-90">
          ...
          <div className="p-10 lg:p-14 bg-[#F5F1E6]/40 backdrop-blur-[1px] border border-[#8F9C86]/15 rounded-[2rem] group hover:bg-[#1F2B1A] hover:text-[#FAF6EE] hover:-translate-y-1 transition-all duration-[0.8s] ease-out shadow-sm hover:shadow-xl">
            <span className="text-[10px] font-sans font-bold tracking-[0.25em] mb-10 block text-[#D27D5B] group-hover:text-[#FAF6EE]/80">🌸 SYS.02</span>
          ...
          <div className="p-10 lg:p-14 bg-[#F5F1E6]/40 backdrop-blur-[1px] border border-[#8F9C86]/15 rounded-[2rem] group hover:bg-[#1F2B1A] hover:text-[#FAF6EE] hover:-translate-y-1 transition-all duration-[0.8s] ease-out shadow-sm hover:shadow-xl">
            <span className="text-[10px] font-sans font-bold tracking-[0.25em] mb-10 block text-[#D27D5B] group-hover:text-[#FAF6EE]/80">🪵 SYS.03</span>
