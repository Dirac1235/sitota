      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-12 reveal-text">
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between border-b border-[#8F9C86]/15 pb-8 gap-6">
          ...
          <div className="mt-4 md:mt-0">
            <Link href="/catalog" className="inline-flex items-center px-8 py-4.5 bg-[#D27D5B] text-[#FAF6EE] text-xs tracking-[0.25em] uppercase font-bold rounded-full hover:bg-[#1F2B1A] transition-colors duration-500 shadow-sm border border-transparent hover:shadow-md">
              New Campaign
            </Link>
          </div>
        </header>
        ...
        <div className="flex flex-wrap gap-8 mb-12 text-[10px] uppercase tracking-[0.25em] font-bold text-[#1F2B1A]/50 border-b border-[#8F9C86]/10 pb-4">
          <Link href="/dashboard" className="text-[#1F2B1A] border-b border-[#1F2B1A] pb-4 -mb-[17px]">Campaign Registry</Link>
          <Link href="/dashboard/designs" className="hover:text-[#1F2B1A] transition-colors pb-4">Design Vault</Link>
          <Link href="/dashboard/address-book" className="hover:text-[#1F2B1A] transition-colors pb-4">Address Book</Link>
          <Link href="/settings/organization" className="hover:text-[#1F2B1A] transition-colors pb-4">Workspace Settings</Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-[#F5F1E6]/30 backdrop-blur-[1px] p-8 border border-[#8F9C86]/15 rounded-[2rem] flex flex-col justify-between group hover:bg-[#FAF6EE] transition-all duration-500 shadow-sm hover:shadow-md">
            ...
            <div className="mt-8">
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#1F2B1A]/40 mt-2">Active log instances</p>
            </div>
          </div>
          ...
          <div className="bg-[#F5F1E6]/30 backdrop-blur-[1px] p-8 border border-[#8F9C86]/15 rounded-[2rem] flex flex-col justify-between group hover:bg-[#FAF6EE] transition-all duration-500 shadow-sm hover:shadow-md">
            ...
            <div className="mt-8">
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#1F2B1A]/40 mt-2">Total investment summary</p>
            </div>
          </div>

          <div className="bg-[#F5F1E6]/30 backdrop-blur-[1px] p-8 border border-[#8F9C86]/15 rounded-[2rem] flex flex-col justify-between group hover:bg-[#FAF6EE] transition-all duration-500 shadow-sm hover:shadow-md">
            <div className="flex justify-between items-start">
              <span className="text-xs uppercase tracking-[0.25em] font-bold text-[#1F2B1A]/50 block">Delivered Items</span>
        ...
        <div className="border border-[#8F9C86]/20 bg-[#F5F1E6]/10 backdrop-blur-[1px] rounded-[2rem] shadow-sm overflow-hidden">
          ...
          {orders.length === 0 ? (
            <div className="py-24 text-center px-6">
              ...
              <Link href="/catalog" className="inline-flex justify-center items-center px-8 py-4.5 bg-[#D27D5B] text-[#FAF6EE] text-xs tracking-[0.25em] uppercase font-bold rounded-full hover:bg-[#1F2B1A] transition-colors duration-500 shadow-sm">
              ...
              {orders.map((order) => {
                ...
                return (
                  <Link 
                    ...
                    className="block p-8 hover:bg-[#FAF6EE]/50 transition-colors duration-500 flex flex-col md:flex-row md:items-center justify-between gap-6 group"
                  >
