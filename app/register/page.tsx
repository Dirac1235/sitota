    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 lg:px-12 bg-[#FDFBF7]">
      <div className="max-w-md w-full border border-[#1c1c1c]/10 bg-white p-8 md:p-12 shadow-sm rounded-none">
        <div className="text-center mb-10">
          <h2 className="font-serif text-3xl md:text-4xl text-[#1c1c1c] tracking-tight">Create Account</h2>
          <p className="mt-2 text-xs uppercase tracking-[0.15em] text-[#1c1c1c]/50 font-semibold">Join the Sitota corporate platform</p>
        </div>
        ...
        <div className="mt-8 text-center border-t border-[#1c1c1c]/5 pt-6">
          <p className="text-sm text-[#1c1c1c]/60 font-light">
            ...
            <Link href="/login" className="font-semibold text-[#1c1c1c] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
